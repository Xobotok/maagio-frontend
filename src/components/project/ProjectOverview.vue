      ...
      <div class="overview-container">
         ...
         <div class="overview-checkboxes">
            <div class="overview-checkbox" :class="{active: showUnits}">
               <label for="show-units"><div class="overview-checkbox-mask"><div class="overview-checkbox-icon"></div></div> Floor Plates and Units</label>
               <input type="checkbox" v-on:change="changeUnits()" v-model="showUnits" id="show-units" style="display: none">
            </div>
            <div class="overview-checkbox" :class="{active: showMap}">
               <label for="show-map"><div class="overview-checkbox-mask"><div class="overview-checkbox-icon"></div></div>Neighborhood Maps</label>
               <input type="checkbox" v-on:change="changeMap()" v-model="showMap" id="show-map" style="display: none">
            </div>
            <div class="overview-checkbox" :class="{active: showGallery}">
            <label for="show-gallery"><div class="overview-checkbox-mask"><div class="overview-checkbox-icon"></div></div>Galleries</label>
            <input type="checkbox" v-on:change="changeGallery()" v-model="showGallery" id="show-gallery" style="display: none">
         </div>
         </div>
      </div>
      <div class="overview-container">
         ...
         <input class="overview-input" :class="{warning: projectName.length < 1}" type="text" v-model="projectName" @keyup="enterName()">
         <div class="overview-logo">
            ...
            <input type="file" v-on:change="renderPreview" id="overview-logo" style="display: none" accept="image/png, image/jpeg">
         </div>
      </div>
   </div>
</template>
