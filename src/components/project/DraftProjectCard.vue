    ...
    <div class="project-card">
        <div class="project-content">
            ...
            <div class="project-menu">
                <router-link :to="{path: 'edit', query: {project_id: project.id}}" class="project-menu-text">CONTINUE</router-link>
      ...
      removeProject(){
        ...
        $.ajax({
          ...
          success: function (respond, status, jqXHR) {
            ...
            if (respond.ok === 1) {
              let projects = obj.$parent.draft_projects;
